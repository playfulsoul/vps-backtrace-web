...
- [ ] **2.1 常用商家 LG 智能模版库**：
  - 输入目标网址后，前端自动推测常用 Looking Glass 路径（如 `/lg-api.php`, `/backend.php`, `/cmd.php`）。
- [ ] **2.2 “一键抓取小书签 (Bookmarklet)” 开发**：
  - 提供可拖拽至书签栏的 JS 脚本。
